      ...
      >
        ...
        >
          <div className='bg-gray-200 rounded-3xl border-2 md:border-3 border-gray-600 hover:bg-gray-300 hover:border-gray-800 px-1 md:px-4 py-1 md:py-2 text-center'>
            <Link to={"/"} onClick={()=>openSecondNavbarCallback(false)}>Home</Link>
          </div>
        </div>
        ...
        >
          <div className=' bg-gray-200 rounded-3xl border-2 md:border-3 border-gray-600 hover:bg-gray-300 hover:border-gray-800 px-1 md:px-4 py-1 md:py-2 text-center'>
            <Link to={'/without-nltk'} onClick={()=>openSecondNavbarCallback(true)}>Without NLTK</Link>
          </div>
          <div className=' bg-gray-200 rounded-3xl border-2 md:border-3 border-gray-600 hover:bg-gray-300 hover:border-gray-800 px-1 md:px-4 py-1 md:py-2 text-center'>
            <Link to={'/with-nltk'} onClick={()=>openSecondNavbarCallback(true)}>With NLTK</Link>
          </div>
          <div className=' bg-gray-200 rounded-3xl border-2 md:border-3 border-gray-600 hover:bg-gray-300 hover:border-gray-800 px-1 md:px-4 py-1 md:py-2 text-center'>
            <Link to={'/with-huggingface'} onClick={()=>openSecondNavbarCallback(true)}>With HuggingFace</Link>
          </div>
        </div>
        ...
        >
          <div className='bg-gray-200 rounded-3xl border-2 md:border-3 border-gray-600 hover:bg-gray-300 hover:border-gray-800 px-1 md:px-4 py-1 md:py-2 text-center'>
            <Link 
              to={'/docs'}
              onClick={()=>openSecondNavbarCallback(false)}
            >Docs</Link>
          </div>
        </div>
      </div> 
